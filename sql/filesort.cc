...
static uint make_sortkey(Sort_param *param, uchar *to)
{
       ...
       sort_field++)
  {
    ...
    {           // Item
      sort_field->item->type_handler()->make_sort_key_part
        (to, sort_field->item, sort_field, &param->tmp_buffer);
...
static uint make_packed_sortkey(Sort_param *param, uchar *to)
{
       ...
       sort_field++)
  {
    ...
    {           // Item
      ...
      length= item->type_handler()->make_packed_sort_key_part
        (to, item, sort_field, &param->tmp_buffer);
      if ((maybe_null= sort_field->item->maybe_null))
        to++;
    }
    to+= length;
